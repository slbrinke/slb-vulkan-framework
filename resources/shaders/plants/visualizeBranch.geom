...
layout(location = 1) in float passAge[];
layout(location = 2) in uint passSpeciesIndex[];
layout(location = 3) in mat4 passNodeModel[];
...
void main() {
    ...
    vec3 p1 = vec3(camera.view * nodeModel * vec4(0.0, 1.0, 0.0, 1.0));
